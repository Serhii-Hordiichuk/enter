...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.startsWith('/_next/static/') || url.pathname === '/icon.svg' || url.pathname === '/icon-maskable.svg') {
    event.respondWith(
  ...
  // Network-first for navigations with an offline shell fallback.
